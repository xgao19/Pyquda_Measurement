...
# === setup cupy cache ===
export CUPY_CACHE_DIR=/lustre/orion/nph158/proj-shared/xgao/l64c64a076/nucleon_TMD_noGPT/cupy_cache
...
#export PYTHONPATH=$PYTHONPATH:/ccs/home/xiangg/latwork/Pyquda_Measurement/utils
#export PYTHONPATH=$PYTHONPATH:/lustre/orion/nph158/proj-shared/xgao/l64c64a076/nucleon_TMD_noGPT/gpt_utils:/lustre/orion/nph158/proj-shared/xgao/l64c64a076/nucleon_TMD_noGPT/gpt_utils/utils:/lustre/orion/nph158/proj-shared/xgao/l64c64a076/nucleon_TMD_noGPT/gpt_utils/qTMD
which python
...
#srun -u --nodes 4 -n 32 -r $offset scripts/./select_gpu_Ncfg python pyquda_prop.py  --config_num 1050 --mpi_geometry 2.2.2.4 >/lustre/orion/nph158/proj-shared/xgao/l64c64a076/nucleon_TMD_noGPT/log/qTMD_1050.out 2>/lustre/orion/nph158/proj-shared/xgao/l64c64a076/nucleon_TMD_noGPT/log/qTMD_1050.err &

srun -u --nodes 4 -n 32 -r $offset scripts/./select_gpu_Ncfg python pyquda_data.py  --config_num 1050 --mpi_geometry 2.2.2.4 >/lustre/orion/nph158/proj-shared/xgao/l64c64a076/nucleon_TMD_noGPT/log/qTMD_1050_data.out 2>/lustre/orion/nph158/proj-shared/xgao/l64c64a076/nucleon_TMD_noGPT/log/qTMD_1050_data.err &
offset=$((offset + 4))
sleep 0.5s
wait
date
