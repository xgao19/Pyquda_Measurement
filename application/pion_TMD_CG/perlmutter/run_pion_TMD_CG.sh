...
export QUDA_RESOURCE_PATH="${QUDA_RESOURCE_PATH:-$script_dir/.quda-cache/pion_TMD_CG}"
export QUDA_PROFILE_OUTPUT_BASE="${QUDA_PROFILE_OUTPUT_BASE:-profile_}"
export CUPY_CACHE_DIR="${CUPY_CACHE_DIR:-$script_dir/.cupy-cache/pion_TMD_CG}"
...
export PION_TMD_BZ="${PION_TMD_BZ:-1}"
...
python3 -u "$script_dir/Pyquda_pion_TMD_CG.py" \
