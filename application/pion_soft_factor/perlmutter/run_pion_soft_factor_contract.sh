...
export QUDA_RESOURCE_PATH="${QUDA_RESOURCE_PATH:-$script_dir/.quda-cache/pion_soft_factor_contract}"
export CUPY_CACHE_DIR="${CUPY_CACHE_DIR:-$script_dir/.cupy-cache/pion_soft_factor_contract}"
...
export PION_SOFT_T_COUNT="${PION_SOFT_T_COUNT:-1}"
export PION_SOFT_QUARK_MOM_Z="${PION_SOFT_QUARK_MOM_Z:-0}"
export PION_SOFT_BT_DIR="${PION_SOFT_BT_DIR:-0}"
export PION_SOFT_BT_LENGTH="${PION_SOFT_BT_LENGTH:-1}"
export PION_SOFT_BZ_LENGTH="${PION_SOFT_BZ_LENGTH:-0}"
export PION_SOFT_TSEP_LIST="${PION_SOFT_TSEP_LIST:-2}"

echo "Running pion soft-factor contraction"
python3 -u "$script_dir/Pyquda_pion_soft_factor_contract.py" "$@"
