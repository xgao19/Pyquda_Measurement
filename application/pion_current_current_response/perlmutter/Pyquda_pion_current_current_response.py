...
first_tau_list = tau_window_list(args.tsep, latt_info.global_size[3], args.first_tau_window, args.first_tau_min)
second_tau_list = tau_window_list(args.tsep, latt_info.global_size[3], args.second_tau_window, args.second_tau_min)
...
cc_response_prop = invert_current_current_response_propagator(
    ...
    first_tau_list=first_tau_list,
    second_tau_list=second_tau_list,
    response_sign=1,
)
