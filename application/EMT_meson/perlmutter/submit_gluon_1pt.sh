...
# Perlmutter job wrapper for the gluonic EMT 1pt measurement.
...
# Keep the runtime aligned with the validated Perlmutter baseline.
...
export EMT_GLUON_1PT_OUT="${EMT_GLUON_1PT_OUT:-$EMT_DATA_DIR/EMTg/gEMT_${EMT_CONFIG_NUM:-1050}}"
