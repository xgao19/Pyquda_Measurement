...
export QUDA_RESOURCE_PATH="${QUDA_RESOURCE_PATH:-$script_dir/.quda-cache/proton_quark_1pt}"
export QUDA_PROFILE_OUTPUT_BASE="${QUDA_PROFILE_OUTPUT_BASE:-profile_}"
export CUPY_CACHE_DIR="${CUPY_CACHE_DIR:-$script_dir/.cupy-cache/proton_quark_1pt}"
export OMP_NUM_THREADS="${OMP_NUM_THREADS:-8}"
export MPICH_GPU_SUPPORT_ENABLED="${MPICH_GPU_SUPPORT_ENABLED:-1}"

export EMT_PROTON_DATA_DIR="${EMT_PROTON_DATA_DIR:-$script_dir/data}"
export EMT_PROTON_GAUGE_PATH="${EMT_PROTON_GAUGE_PATH:-$software_root/Pyquda_Measurement/test_gauge/S8T32_wilson_b6.cg.1e-08.0}"
export EMT_PROTON_CONFIG_NUM="${EMT_PROTON_CONFIG_NUM:-0}"
export EMT_PROTON_MPI_GEOMETRY="${EMT_PROTON_MPI_GEOMETRY:-1.1.1.1}"
export EMT_PROTON_QMAX="${EMT_PROTON_QMAX:-0}"
export EMT_PROTON_FLOW_STEPS="${EMT_PROTON_FLOW_STEPS:-1}"
export EMT_PROTON_TOL="${EMT_PROTON_TOL:-1e-10}"
export EMT_PROTON_N_ZN="${EMT_PROTON_N_ZN:-4}"
export EMT_PROTON_RAND_SEED="${EMT_PROTON_RAND_SEED:-0}"

mkdir -p "$QUDA_RESOURCE_PATH" "$CUPY_CACHE_DIR" "$EMT_PROTON_DATA_DIR"

echo "Running proton quark EMT 1pt"
python3 -u "$script_dir/Pyquda_EMT_proton_quark_1pt.py" \
