...
export QUDA_RESOURCE_PATH="${QUDA_RESOURCE_PATH:-$script_dir/.quda-cache/flowed_disc_gluon_1pt}"
export QUDA_PROFILE_OUTPUT_BASE="${QUDA_PROFILE_OUTPUT_BASE:-profile_}"
export CUPY_CACHE_DIR="${CUPY_CACHE_DIR:-$script_dir/.cupy-cache/flowed_disc_gluon_1pt}"
...
echo "Running flowed disconnected gluon 1pt"
python3 -u "$script_dir/Pyquda_flowed_disc_gluon_1pt.py" \
