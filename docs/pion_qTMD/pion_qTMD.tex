...
\begin{enumerate}[nosep]
  ...
  \item Attach sink gammas to backward line: einsum
        \texttt{"wtzyxjicf,gim->gwtzyxjmcf"}.
  \item Contract with forward propagator and source gammas: einsum
        \texttt{"gwtzyxjiab,wtzyxilba,glj->gwtzyx"}.
  \item Fourier-project with \texttt{phases}: einsum
        \texttt{"qwtzyx,gwtzyx->gqt"}.
