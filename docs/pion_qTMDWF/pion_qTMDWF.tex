...
backward propagator.  Frontier and Aurora then call the same shared
\texttt{contract\_qtmdwf\_gamma\_scan} kernel for the 16-Gamma contraction
...
\texttt{contract\_qtmdwf\_gamma\_scan} helper for each displaced backward
